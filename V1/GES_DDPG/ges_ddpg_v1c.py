...
"""
    ddpg_v1 + 用ges梯度作为代理梯度 + 用RL梯度来更新policy + 无 buffer flush
"""
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            if self.elite_size != 0:
                ...
                grad = self.policy.update_by_ges(elite_pos_rewards, elite_neg_rewards, elite_epsilons, std_rewards)
            else:
                grad = self.policy.update_by_ges(pos_rewards, neg_rewards, epsilons, std_rewards)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir_path', type=str, default='results_v1c/')
